...
function Footer() {
return (
    <section className="relative overflow-hidden py-10 bg-neutral-100 border-t border-gray-300">
                        ...
                        <div className="flex h-full flex-col justify-between">
                            ...
                            <div>
                                <p className="text-sm text-gray-600">
                                     &copy; {new Date().getFullYear()}. Created by G.K. Design inspired by DevUI tutorial.
                                </p>
                            </div>
                        </div>
                    </div>
